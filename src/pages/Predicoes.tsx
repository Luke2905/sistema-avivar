...
export default function Predicoes() {
  ...
  if (loading) return (
    <div className="h-full bg-gray-50 flex flex-col items-center justify-center text-indigo-600">
  ...
  return (
    // 1. ESTRUTURA TRAVADA (Igual às outras telas)
    <div className="flex flex-col h-full bg-gray-50 overflow-hidden">
      ...
      {/* 3. ÁREA DE SCROLL (O conteúdo rola aqui dentro) */}
